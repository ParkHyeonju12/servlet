...
<script type="text/javascript" src="https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=n7jcn0e08p&submodules=geocoder"></script>
</head>
<body>
...
<div class="page-content">
		...
		<input type="text" id="address" name="address" class="input-form" readonly>
...
<script>
	const map = new naver.maps.Map("map",{
		center : new naver.maps.LatLng(37.533837,126.89683),
		zoom : 16,
		zoomControl : true,
		zoomControlOptions : {
	...
	const marker = new naver.maps.Marker({
		position : new naver.maps.LatLng(37.533837,126.89683),
		map : map
	});
	let contentString = [
		"<div class='iw_inner'>",
		"	<h3>KH정보교육원</h3>",
		"<p>서울시 영등포구 선유동 2로 57 이레빌딩 19F A강의장</p>",
		"</div>"
	].join("");
	...
	naver.maps.Event.addListener(map,"click",function(e){
		...
		if(infoWindow.getMap()){//정보창이 지도 위에 올라가 있으면
			infoWindow.close();	
		}
