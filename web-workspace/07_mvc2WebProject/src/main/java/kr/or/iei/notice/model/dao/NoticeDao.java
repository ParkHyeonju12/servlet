...
public class NoticeDao {
	...
	public int deleteNotice(Connection conn, int noticeNo) {
		PreparedStatement pstmt = null;
		int result = 0;
		String qurey = "delete from notice where notice_no=?";
		try {
	...
	public int updateReadCount(Connection conn, Notice n) {
		PreparedStatement pstmt = null;
		int result = 0;
	...
	public int inserNoticeComment(Connection conn, NoticeComment nc) {
		PreparedStatement pstmt = null;
		int result = 0;
		String query = "insert into notice_comment values";
		query += "(nc_seq.nextval,?,?,to_char(sysdate,'yyyy-mm-dd'),?,?)";
		try {
			pstmt = conn.prepareStatement(query);
