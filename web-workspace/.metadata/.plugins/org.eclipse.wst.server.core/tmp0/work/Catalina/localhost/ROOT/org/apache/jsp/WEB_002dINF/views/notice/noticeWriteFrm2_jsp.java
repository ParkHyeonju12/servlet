 ...
 * Generated at: 2022-09-07 08:10:57 UTC
...
if(m == null){ 
      ...
      out.write("		<!--첨부파일은 method=\"post\" enctype=\"multipart/form-data\" 이거 두가지는 반드시 들어가줘야댐  \r\n");
      out.write("	첨부파일이 포함 안되는건 enctype=\"multipart/form-data\" 생략. 근데 그냥 들어갈지도 모르면 무조건 쓰기\r\n");
      out.write("	-->\r\n");
      ...
      out.write("			//ajax통해서 서버에 이미지를 업로드\r\n");
      ...
      out.write("				}\r\n");
      out.write("			});\r\n");
      out.write("			//processDate : 전송하는 데이터를 문자열로 전송하게 기본값이 설정되어있음\r\n");
      out.write("					//		-> 파일 전송을 위해 기본값 제거하는 작업\r\n");
      out.write("			//contentType : enctype=\"application/x-www-form-urlencoded;charser=UTF-8\"\r\n");
      out.write("			//				-> 설정되어있는 기본 enctype을 제거\r\n");
      out.write("		}\r\n");
      out.write("	</script>\r\n");
      out.write("	");
      out.write("\r\n");
